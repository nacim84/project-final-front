...
export const CommonGetters = () => {
 return (
  <Card className="flex items-center justify-between gap-4 w-full h-full bg-primary-foreground min-w-[60vw] py-4 px-6 rounded-lg shadow-lg">
   ...
   <div className="mx-auto w-full">
    <CommonDialog component={<GetVotedVoterVoterForm />} variant={"default"} className='font-semibold' text="Vérifier votre vote" title="Vérifier votre vote" icon={<FileUp className='h-5 w-5' />} size="lg" />
   </div>
   <div className="mx-auto w-full">
   ...
   <div className="mx-auto w-full">
    <CommonDialog component={<GetVoteCommonForm />} variant={"default"} className='font-semibold' text="Consulter un vote cloturé" title="Consulter un vote cloturé" icon={<FileUp className='h-5 w-5' />} size="lg" />
   </div>
  </Card>
 )
};